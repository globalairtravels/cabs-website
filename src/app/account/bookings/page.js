...
// My Bookings (/account/bookings). For signed-in users, queries
// bookings where uid == auth.uid ordered by createdAt desc (rules-gated,
// backed by the composite index in firestore.indexes.json).
// Guests are pointed at the ID + phone tracker on the home page.
